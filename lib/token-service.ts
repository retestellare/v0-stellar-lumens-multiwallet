...
/**
 * Get curated token picks - verified mainnet tokens with images
 */
export const getTokenPicks = (): TokenMetadata[] => [
  ...
  {
    code: 'SHX',
    issuer: 'GDSTRSHXHGJ7ZIVRBXEYE5Q74XUVCUSEZ6GKPNAC4ZISIJEJNLBPA4FT',
    name: 'Stronghold SHX',
    domain: 'stronghold.co',
    image: 'https://assets.coingecko.com/coins/images/31254/small/SHX.png',
    verified: true,
    source: 'stellar-expert',
  },
  {
    ...
    name: 'Realio Token',
    domain: 'realio.fund',
    image: 'https://assets.coingecko.com/coins/images/12206/small/realio.png',
    verified: true,
    source: 'stellar-expert',
  },
  {
    ...
    name: 'ARS Token',
    domain: 'anclap.com',
    image: 'https://www.anclap.com/wp-content/uploads/2024/01/arsIcon.svg',
    verified: true,
    source: 'stellar-expert',
  },
  {
    ...
    name: 'BRL Token',
    domain: 'ntokens.com',
    image: 'https://ntokens.com/img/brlt-icon.png',
    verified: true,
    source: 'stellar-expert',
  },
  {
    ...
    name: 'Velo Token',
    domain: 'velo.org',
    image: 'https://assets.coingecko.com/coins/images/12722/small/velo.png',
    verified: true,
    source: 'stellar-expert',
  },
  {
